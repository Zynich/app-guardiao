            ...
            <form method="POST" action="{{ route('admin.users.update', $user) }}" class="p-5 space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="badge_number" value="{{ old('badge_number', $user->badge_number) }}" maxlength="20"
                    ...
                    <div class="space-y-2" x-data="inputMasks()">
                        ...
                        <input type="text" name="phone" value="{{ old('phone', $user->phone) }}" maxlength="15" inputmode="numeric"
                    ...
                    <div class="space-y-2" x-data="inputMasks()">
                        ...
                        <input type="text" name="cpf" value="{{ old('cpf', $user->cpf) }}" maxlength="14" inputmode="numeric"
