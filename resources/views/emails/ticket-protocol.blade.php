...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .body { padding: 32px; }
        .greeting { font-size: 15px; color: #a1a1aa; margin-bottom: 24px; line-height: 1.6; }
        ...
        .detail-row { display: flex; justify-content: space-between; padding: 8px 0; border-bottom: 1px solid rgba(63,63,70,0.3); }
        .detail-row:last-child { border-bottom: none; }
        .detail-label { font-size: 11px; font-weight: 700; color: #71717a; text-transform: uppercase; letter-spacing: 0.1em; }
        .detail-value { font-size: 13px; font-weight: 600; color: #e4e4e7; text-align: right; max-width: 60%; }
